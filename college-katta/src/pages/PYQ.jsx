...
import { FaSearch, FaDownload, FaBookmark, FaRegBookmark, FaSpinner, FaFilter } from 'react-icons/fa';
...
const PYQ = () => {
  ...
  useEffect(() => {
    // In a real app, this would be an API call to get question papers
    const fetchQuestionPapers = async () => {
      setLoading(true);
      try {
        // Get files with type "Question Paper"
        const files = searchFiles('', { type: 'Question Paper (PYQ)' });
    ...
    fetchQuestionPapers();
  }, [searchFiles, bookmarkedFiles]); // Add bookmarkedFiles as dependency
  
  const handleSearch = (e) => {
    e.preventDefault();
    const searchFilters = { type: 'Question Paper (PYQ)', ...filters };
    const results = searchFiles(searchTerm, searchFilters);
    setQuestionPapers(results);
  };
  ...
  const handleFilterChange = (e) => {
    ...
    const searchFilters = { type: 'Question Paper (PYQ)', ...updatedFilters };
    const results = searchFiles(searchTerm, searchFilters);
    setQuestionPapers(results);
  };
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">
          Browse and download question papers from previous years
        </p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-8">
        ...
        {loading ? (
          <div className="flex justify-center items-center py-20">
            ...
            <span className="text-lg text-gray-600">Loading question papers...</span>
          </div>
          ...
          <div className="text-center py-16">
            ...
            <h3 className="mt-2 text-lg font-medium text-gray-900">No question papers found</h3>
              ...
              <div key={file._id || file.id} className="bg-white rounded-lg shadow-sm overflow-hidden transition-transform hover:translate-y-[-5px] hover:shadow-lg border border-gray-100">
                <div className="relative bg-indigo-50 pt-8 pb-10 flex items-center justify-center">
                  ...
                  <div className="relative">
                    <svg className="h-16 w-16 text-orange-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
                      <path fill="currentColor" d="M224 136V0H24C10.7 0 0 10.7 0 24v464c0 13.3 10.7 24 24 24h336c13.3 0 24-10.7 24-24V160H248c-13.2 0-24-10.8-24-24zm64 236c0 6.6-5.4 12-12 12H108c-6.6 0-12-5.4-12-12v-8c0-6.6 5.4-12 12-12h168c6.6 0 12 5.4 12 12v8zm0-64c0 6.6-5.4 12-12 12H108c-6.6 0-12-5.4-12-12v-8c0-6.6 5.4-12 12-12h168c6.6 0 12 5.4 12 12v8zm0-72v8c0 6.6-5.4 12-12 12H108c-6.6 0-12-5.4-12-12v-8c0-6.6 5.4-12 12-12h168c6.6 0 12 5.4 12 12zm96-114.1v6.1H256V0h6.1c6.4 0 12.5 2.5 17 7l97.9 98c4.5 4.5 7 10.6 7 16.9z"/>
                    </svg>
                    <div className="absolute bottom-0 left-0 right-0 bg-orange-500 text-white text-xs py-0.5 text-center">
